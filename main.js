...
{
	Swal.fire({
	html: "Este cuento es interactivo. Podés:<br><b>A.</b> Combinar las partes haciendo click en los párrafos.<br><b>B.</b> Leer las tres partes por separado, usando los círculos de colores.",
	icon: "info",
	width: 600
	})
}
